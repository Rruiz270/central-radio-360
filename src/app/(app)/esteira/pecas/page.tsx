...
export default async function PecasPage({ searchParams }: { searchParams: Promise<{ pi?: string }> }) {
  ...
  return (
    <section className="view on">
      <Hint style={{ marginBottom: 16 }}>
        <b>Produção de peças</b> é a ponte entre a O.S. e o ar: roteiro, gravação, aprovação do cliente e
        liberação. A aprovação usa o <b>Portal do Cliente</b> que já existe — sem criar um segundo canal.
        Não confundir com o <b>C.P. (Custo de Produção)</b>, que é a planilha de custo do job, no Financeiro.
      </Hint>
      ...
      <SecTitle>Produção de peças</SecTitle>
