...
const P: Record<string, React.ReactNode> = {
  ...
  esteira: <><rect x="2" y="2.5" width="6" height="5" rx="1.2" /><rect x="10" y="2.5" width="6" height="5" rx="1.2" /><rect x="2" y="10.5" width="6" height="5" rx="1.2" /><rect x="10" y="10.5" width="6" height="5" rx="1.2" /><path d="M8 5h2M8 13h2M5 7.5v3M13 7.5v3" /></>,
  po: <><rect x="3" y="2" width="12" height="14" rx="1.8" /><path d="M6 6h6M6 9h6M6 12h3.5" /></>,
  pi: <><rect x="2.5" y="3.5" width="13" height="11" rx="1.6" /><path d="M2.5 7h13M6.5 3.5v11" /></>,
  pd: <><circle cx="9" cy="4.5" r="2" /><circle cx="4" cy="13.5" r="2" /><circle cx="14" cy="13.5" r="2" /><path d="M9 6.5v3M9 9.5H4.8v2M9 9.5h4.2v2" /></>,
  os: <><rect x="3" y="2.5" width="12" height="13" rx="1.8" /><path d="M6 6.5h6M6 9.5h6M6 12.5h4" /><circle cx="13.6" cy="13.4" r="3" fill="none" /><path d="M12.4 13.4l.9.9 1.6-1.8" /></>,
  cp: <><path d="M9 2.5a3 3 0 0 1 3 3v3a3 3 0 0 1-6 0v-3a3 3 0 0 1 3-3Z" /><path d="M4 8.5a5 5 0 0 0 10 0M9 13.5V16M6.5 16h5" /></>,
  pv: <><path d="M2.5 9a6.5 6.5 0 0 1 13 0" /><circle cx="9" cy="12.5" r="2.2" /><path d="M5.5 9a3.5 3.5 0 0 1 7 0" /></>,
