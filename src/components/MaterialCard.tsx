...
export function MaterialCard({ id, kind, title, status: initialStatus, note, token }: {
  id: number; kind: string; title: string; status: string; note?: string | null; token?: string;
}) {
